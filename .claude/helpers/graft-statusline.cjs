...
// Résolu à l'exécution uniquement. L'installeur grave ici le chemin absolu de la
// machine qui l'a lancé — inexistant ailleurs, et porteur d'un nom de compte. La
// chaîne de repli ci-dessous (node_modules du projet, puis `npm root -g`) couvre
// tous les cas ; réappliquez cette ligne si une réinstallation la réécrit.
const BAKED = null;
